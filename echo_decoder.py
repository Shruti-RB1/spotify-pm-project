...
# ── FIX: CTA moved up here, right under the hero, BEFORE the 2-column
#    review layout — so it's visible without scrolling past 30 reviews.
cta_col1, cta_col2 = st.columns([1, 2])
with cta_col1:
    analyze_now = st.button(f"✨ Analyze {len(REVIEWS)} reviews with AI", type="primary", use_container_width=True)
with cta_col2:
